 ...
 */
final class Version20201028141851 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE vehicule ADD CONSTRAINT FK_292FFF1DD725330D FOREIGN KEY (agence_id) REFERENCES agence_location (id)');
